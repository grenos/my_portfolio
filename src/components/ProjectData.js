...
export const ProjectData = [
  ...
  },
  {
    ...
    info: `A Web app to see the latest movie and TV serie releases along with trailers, similar recomandations and production and actors' info. All build into a Popcorn Time style theme \u{1F4FD}`,
